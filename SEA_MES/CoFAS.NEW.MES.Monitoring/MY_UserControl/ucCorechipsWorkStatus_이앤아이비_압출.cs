...
{
    public partial class ucCorechipsWorkStatus_이앤아이비_압출 : UserControl
    {

        public DataRow _dataRow = null;


        public ucCorechipsWorkStatus_이앤아이비_압출(DataRow dataRow )
        {
            _dataRow = dataRow;
            InitializeComponent();

        }
        public ucCorechipsWorkStatus_이앤아이비_압출()
        {
