...
{
    public partial class FormDownload_Tapex : Form
    {
        ...
        public FormDownload_Tapex(string sqlcon, string updatetype, string runName)
        {
            _sqlcon = sqlcon;
        ...
        private void FormDownload_Tapex_Load(object sender, EventArgs e)
        {
            try
            {
