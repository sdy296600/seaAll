...
{
    public partial class 제품초중종기준_PopupBox : Form
    {
        #region ○ 폼 이동
        ...
        public 제품초중종기준_PopupBox(string ID 
            , string userEntity
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _MenuSettingEntity.BASE_TABLE = "STOCK_INSPECTION_STANDARD";
                label1.Text = "현재 품목 : " + _STOCK_OUT_CODE + " , " + _STOCK_NAME;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string str = $@"SELECT 
                                      ...
                                      ,A.INSPECTION_POINT       AS 'A.INSPECTION_POINT'
