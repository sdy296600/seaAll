...
{
    public partial class 제품스펙_PopupBox : Form
    {
        #region ○ 폼 이동
        ...
        public 제품스펙_PopupBox(string ID 
            , string userEntity
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _MenuSettingEntity.BASE_TABLE = "STOCK_MST_SPEC";
        ...
        private void MainSave_InputData()
        {
            try
            {
                ...
                //}
                fpMain.Focus();
                bool _Error = new CoreBusiness().BaseForm1_A10(_MenuSettingEntity,fpMain, "STOCK_MST_SPEC");
                if (!_Error)
                {
