...
{
    public partial class 계측기이력관리 : DoubleBaseForm1
    {
        ...
        {
            fpMain.Sheets[0].Columns["NAME"].AllowAutoFilter = true;
        }
        ...
        public override void SubFind_DisplayData()
        {
            try
            {
                ...
                string str = $@"select *
                              from [dbo].[INSTRUMENT_DETAIL]
                              WHERE 1=1
                              AND INSTRUMENT_MST_ID = {_Mst_Id}
                              AND USE_YN = 'Y'";
        ...
        public override void _AddItemButtonClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                fpSub.Sheets[0].SetValue(fpSub.Sheets[0].ActiveRowIndex, "INSTRUMENT_MST_ID              ".Trim(), fpMain.Sheets[0].GetValue(row, "ID ".Trim()));
