...
{
    public partial class CHANGE_MANAGEMENT : DoubleBaseForm1
    {
        public CHANGE_MANAGEMENT()
        {
            InitializeComponent();
        ...
        public override void _AddItemButtonClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                fpSub.Sheets[0].SetValue(fpSub.Sheets[0].ActiveRowIndex, "STOCK_MST_ID      ".Trim(), fpMain.Sheets[0].GetValue(row, "ID      ".Trim()));
                fpSub.Sheets[0].SetValue(fpSub.Sheets[0].ActiveRowIndex, "STOCK_MST_OUT_CODE".Trim(), fpMain.Sheets[0].GetValue(row, "ID".Trim()));
