...
{
    public partial class TripleBaseForm1 : frmBaseNone
    {
        ...
        public virtual void Form_Load(object sender, EventArgs e)
        {
            try
            {
                if (this._pMenuSettingEntity != null)
                {
                    ...
                    DataTable pDataTable3 =  new CoreBusiness().BASE_MENU_SETTING_R10(this._pMenuSettingEntity.MENU_WINDOW_NAME,fpSub2,pBASE_TABLE2);
                    ...
                    if (pDataTable3 != null)
                    {
                       // initializeSpread(pDataTable3, fpSub2);
                        Function.Core.initializeSpread(pDataTable3, fpSub2, this._pMenuSettingEntity.MENU_WINDOW_NAME, MainForm.UserEntity.user_account);
                    }
