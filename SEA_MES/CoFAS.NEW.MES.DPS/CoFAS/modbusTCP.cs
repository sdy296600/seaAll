...
namespace CoFAS.NEW.MES.DPS
{
    ...
    public class Master
    {
        ...
        public void ReadCoils(ushort id, byte unit, ushort startAddress, ushort numInputs)
        {
            ...
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, fctReadCoil), startAddress);
        }
        ...
        /// <param name="startAddress">Address from where the data read begins.</param>
        /// <param name="numInputs">Length of data.</param>
        public bool ReadHoldingRegister(ushort id, byte unit, ushort startAddress, ushort numInputs)
        {
            if (numInputs > 125)
            {
            ...
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, fctReadHoldingRegister), startAddress);
